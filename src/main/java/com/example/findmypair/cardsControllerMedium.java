...
public class cardsControllerMedium implements Initializable {
    ...
    MemoryGameMediumMode memoryGameMediumMode = new MemoryGameMediumMode();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        memoryGameMediumMode.setupGame();
    ...
    void buttonClicked(ActionEvent event) throws IOException {
        if(!firstButtonClicked){
            ...
            Color color = memoryGameMediumMode.getOptionAtIndex(firstButtonIndex);
        ...
        Color color = memoryGameMediumMode.getOptionAtIndex(secondButtonIndex);
        BackgroundFill backgroundFill = new BackgroundFill(color, CornerRadii.EMPTY, Insets.EMPTY);
        Background background = new Background(backgroundFill);
        ...
        if(memoryGameMediumMode.checkTwoPositions(firstButtonIndex,secondButtonIndex)){
            score += 50;
            updateLabels();
            match = true;
            matchedButtons += 2;
    ...
    private void saveScores() {
        try {
            FileWriter fileWriter = new FileWriter("C:\\Users\\jaira\\IdeaProjects\\findMyPair\\src\\main\\java\\scoresTextFiles\\mediumScores.txt", true);
    ...
    private void showButtons(){
        for (int i = 0; i < 18; i++) {
            Color color = memoryGameMediumMode.getOptionAtIndex(i);
            BackgroundFill backgroundFill = new BackgroundFill(color, CornerRadii.EMPTY, Insets.EMPTY);
            Background background = new Background(backgroundFill);
