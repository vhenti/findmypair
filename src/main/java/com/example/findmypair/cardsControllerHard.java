...
public class cardsControllerHard implements Initializable {
    ...
    MemoryGameHardMode memoryGameHardMode = new MemoryGameHardMode();
    ...
    void buttonClicked(ActionEvent event) throws IOException {
        ...
        if(!firstButtonClicked){
            ...
            Color color = memoryGameHardMode.getOptionAtIndex(firstButtonIndex);
        ...
        Color color = memoryGameHardMode.getOptionAtIndex(secondButtonIndex);
        BackgroundFill backgroundFill = new BackgroundFill(color, CornerRadii.EMPTY, Insets.EMPTY);
        Background background = new Background(backgroundFill);
        ...
        if(memoryGameHardMode.checkTwoPositions(firstButtonIndex,secondButtonIndex)){
            score += 50;
            match = true;
            matchedButtons += 2;
    ...
    private void saveScores() {
        try {
            FileWriter fileWriter = new FileWriter("C:\\Users\\jaira\\IdeaProjects\\findMyPair\\src\\main\\java\\scoresTextFiles\\hardScores.txt", true);
    ...
    private void showButtons(){
        for (int i = 0; i < 24; i++) {
            Color color = memoryGameHardMode.getOptionAtIndex(i);
            BackgroundFill backgroundFill = new BackgroundFill(color, CornerRadii.EMPTY, Insets.EMPTY);
            Background background = new Background(backgroundFill);
